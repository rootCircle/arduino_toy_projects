...
void draw() {
  //g=0;
  background(constrain(mouseX / 2, 0, 255),g,constrain(mouseY / 2, 0, 255));
  ...
  arduino.analogWrite(11, constrain(mouseY / 2, 0, 255));
  println(constrain(mouseX / 2, 0, 255),g,constrain(mouseY / 2, 0, 255));
  delay(1);
}
